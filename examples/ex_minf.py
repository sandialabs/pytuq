...
# Create noisy synthetic data from a quadratic model
data_sigma = 0.05
npt = 13
...
# Calibration model (quadratic) and its parameter dimension
calib_model, calib_model_params = quad_model, xd
pdim = 3


# Sobol sensitivity analysis before calibration
...
# Subset of data indices used for calibration
ind_calib = [1, 4, 11]
...
# Inference configuration: prior, likelihood, data variance model, and calibration method
model_infer_config = {
...
# Postprocess: evaluate posterior predictive at all data points
...
# Plot the posterior fit against data
